...
REM
REM Generated by Vivado on Thu May 19 22:28:54 +0300 2022
...
echo "xvhdl --incr --relax -prj proc_mc_tb_vhdl.prj"
call xvhdl  --incr --relax -prj proc_mc_tb_vhdl.prj -log xvhdl.log
